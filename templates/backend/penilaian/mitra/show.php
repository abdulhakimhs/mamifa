...
<div class="col-xs-12 col-sm-12 widget-container-col" id="widget-container-col-1">
  <div class="widget-box widget-color-dark" id="widget-box-1">
    <div class="widget-header">
      <h5 class="widget-title">Penilaian Mitra <?= $subtitle ?></h5>
...
<script type="text/javascript">
  ...
  function detail(id)
  {
      ...
      $.ajax({
          url : "<?php echo site_url('admin/penilaian/mitra/detail')?>/" + id,
          type: "GET",
          dataType: "JSON",
          success: function(data)
          {
              ...
              $('[name="jenis_teknisi"]').val(data.jenis_teknisi);
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-md-9">
                                  <input name="nama_mitra" class="form-control" type="text" readonly>
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="control-label col-md-3">Jenis Mitra</label>
                              <div class="col-md-9">
                                  <input name="jenis_mitra" class="form-control" type="text" readonly>
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="control-label col-md-3">Jenis Teknisi</label>
                              <div class="col-md-9">
                                  <input name="jenis_teknisi" class="form-control" type="text" readonly>
                                  <span class="help-block"></span>
                              </div>
                          </div>
                          <div class="form-group">
...
<script type="text/javascript">
  ...
  function save()
  {
      ...
      $.ajax({
          url : "<?php echo site_url('admin/penilaian/mitra/insert_nilai')?>",
          type: "POST",
          data: $('#form').serialize(),
          dataType: "JSON",
          success: function(data)
