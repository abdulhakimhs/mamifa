<div class="col-xs-12 col-sm-12 widget-container-col" id="widget-container-col-1">
	<div class="widget-box widget-color-dark" id="widget-box-1">
		<div class="widget-header">
			<h5 class="widget-title">Training Request</h5>
...
function detail(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin/training_request/ajax_edit/')?>" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
 
            $('[name="id"]').val(data.training_request_id);
			$('[name="nik"]').val(data.nik);
			$('[name="nama_lengkap"]').val(data.nama_lengkap);
            $('[name="level"]').val(data.level);
            $('[name="sub_level"]').val(data.sub_level);
			$('[name="jenis_pelatihan"]').val(data.jenis_pelatihan);
			$('[name="alasan_permintaan"]').val(data.alasan_permintaan);
...
function delete_data(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/training_request/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
						...
						<div class="col-lg-12">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<div class="col-md-9">
										<input name="level" class="form-control" type="text" readonly>
										<span class="help-block"></span>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-3">Sub Level</label>
									<div class="col-md-9">
										<input name="sub_level" class="form-control" type="text" readonly>
										<span class="help-block"></span>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-9">
										<input name="jenis_pelatihan" class="form-control" type="text" readonly>
										<span class="help-block"></span>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-3">Alasan Permintaan</label>
									<div class="col-md-9">
										<textarea name="alasan_permintaan" class="form-control" readonly></textarea>
										<span class="help-block"></span>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-md-3">Status Training Request</label>
									<div class="col-md-9">
										<select name="status_training" class="form-control">
