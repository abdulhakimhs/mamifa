<div class="col-xs-12 col-sm-12 widget-container-col" id="widget-container-col-1">
	<div class="widget-box widget-color-dark" id="widget-box-1">
		<div class="widget-header">
			<h5 class="widget-title">Data Slider</h5>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
		...
		"ajax": {
			"url": "<?php echo site_url('admin/masters/slider/get_ajax') ?>",
			"type": "POST"
		},
...
function add_data()
{
    ...
    $('#label-photo').text('Upload Gambar Slider'); // label photo upload
}
...
function detail(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin/masters/slider/ajax_edit/')?>" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            if(data.slide_image)
            {
                $('#label-photo').text('Change Slider'); // label photo upload
                $('#photo-preview div').html('<img src="'+base_url+'assets/backend/images/slider/'+data.slide_image+'" class="img-responsive">'); // show photo
                $('#photo-preview div').append('<input type="checkbox" name="remove_photo" value="'+data.slide_image+'"/> Remove photo when saving'); // remove photo
            }
            else
            {
                $('#label-photo').text('Upload Gambar Slider'); // label photo upload
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/masters/slider/ajax_add')?>";
    } else {
        url = "<?php echo site_url('admin/masters/slider/ajax_update')?>";
	}
...
function delete_data(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/masters/slider/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <select name="slide_active" id="slide_active" class="form-control">
