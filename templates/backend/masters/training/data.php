<div class="col-xs-12 col-sm-12 widget-container-col" id="widget-container-col-1">
	<div class="widget-box widget-color-dark" id="widget-box-1">
		<div class="widget-header">
			<h5 class="widget-title">Data Training</h5>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
		...
		"ajax": {
			"url": "<?php echo site_url('admin/masters/training/get_ajax') ?>",
			"type": "POST"
		},
...
function detail(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin/masters/training/ajax_edit/')?>" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
 
            $('[name="id"]').val(data.not_id);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/masters/training/ajax_add')?>";
    } else {
        url = "<?php echo site_url('admin/masters/training/ajax_update')?>";
	}
...
function delete_data(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/masters/training/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
